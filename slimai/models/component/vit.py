...
class FlexViT(models.VisionTransformer):
  vit_arch = {
    "tiny":  dict(patch_size=16, embed_dim=192, depth=12, num_heads=3, mlp_ratio=4.0), 
    "small": dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, mlp_ratio=4.0), 
    "base":  dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4.0), 
    "large": dict(patch_size=16, embed_dim=1024, depth=24, num_heads=16, mlp_ratio=4.0), 
    "huge":  dict(patch_size=16, embed_dim=1280, depth=32, num_heads=16, mlp_ratio=4.0), 
    "giant": dict(patch_size=16, embed_dim=1536, depth=40, num_heads=24, mlp_ratio=4.0), 
  }
